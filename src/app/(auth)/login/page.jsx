...
const page = () => {
  return (
    <div className='relative flex flex-col items-center w-full h-full justify-center px-24'>
            ...
            <p className='text-base font-medium text-gray-400 mt-2'>Log in to connect anonymously, honestly, and safely.</p>
...
<div className="flex flex-col px-12 mt-24 w-full">
     <div className="flex flex-col gap-1 w-full">
                ...
                <Input placeholder="Enter Email" type={"email"} className={`font-semibold w-full`}/>
            </div>
            <div className="flex flex-col gap-1 mt-4 w-full">
                <label htmlFor="password" className='font-medium text-gray-300'>Password</label>
                <Input placeholder="Enter password" type={"password"} className={`font-semibold w-full`}/>
            </div>
            <Button className={`font-semibold cursor-pointer text-lg mt-6 w-full`}>Sign in</Button>
            ...
            <Button variant='link' className={`cursor-pointer -ml-4`}><Link href={"/register"}>Register</Link></Button></p>
</div>
