...
const page = () => {
  const { userObject, setUserObject, login } = useAuth();
  return (
    <div className="relative flex flex-col items-center w-full h-full justify-center px-24">
      ...
      <p className="text-base font-medium text-gray-400 mt-2">
        Log in to connect anonymously, honestly, and safely.
      </p>
      ...
      <div className="flex flex-col px-12 mt-24 w-full">
        <div className="flex flex-col gap-1 w-full mt-4">
          ...
          <Input
            ...
            onChange={(e) => setUserObject(e.target.name, e.target.value)}
          />
        </div>
        ...
        <Button
          className={`font-semibold cursor-pointer text-lg mt-6 w-full`}
          onClick={login}
        >
          Sign in
        </Button>
        <p className="flex gap-1 items-center mt-2 text-center w-full justify-center">
